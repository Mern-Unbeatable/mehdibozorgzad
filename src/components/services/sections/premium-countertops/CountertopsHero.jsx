...
const HERO_BG = '/constgallery9.jpg';

const CountertopsHero = memo(() => (
    ...
    <div className="relative h-full flex flex-col justify-center container mx-auto px-4">
      <div className="flex flex-col gap-5 max-w-xl lg:max-w-2xl">
        ...
        <p className="text-white text-base leading-7">
          Custom-designed countertops crafted with premium materials, delivering durability,
          functionality, and a sleek, modern finish tailored to your space.
        </p>
      </div>
    </div>
  </section>
...
CountertopsHero.displayName = 'CountertopsHero';

export default CountertopsHero;
